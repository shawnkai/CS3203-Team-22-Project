...
TEST_CASE("TestCase2_TokenizeWhileStatement_ShouldSuccess") {
    ...
    const char *relativePath;
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut2.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
...
TEST_CASE("TestCase3_TokenizeIfStatement_ShouldSuccess") {
    ...
    const char *relativePath;
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut3.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
...
TEST_CASE("TestCase4_TokenizeReadPrintStatement_ShouldSuccess") {
    ...
    const char *relativePath;
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut4.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
...
TEST_CASE("TestCase5_TokenizeAssignStatement_ShouldSuccess") {
    ...
    const char *relativePath;
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut5.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
...
TEST_CASE("TestCase6_TokenizeComplexSimpleSource_ShouldSuccess") {
    ...
    const char *relativePath;
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut6.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
...
#if __APPLE__
    relativePath = "SPTestingResources/SP_ut7.txt";
#endif
    try {
        tokenList = tk.tokenize(relativePath);
    } catch (std::invalid_argument& e) {
