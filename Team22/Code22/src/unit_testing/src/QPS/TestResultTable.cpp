...
TEST_CASE("TestCase1_MatchingSingleColumnMatchingRows") {
    auto *table1 = new ResultTable({make_pair<string, vector<string>>("s", {"1", "2", "2", "3", "4", "5"}),
                                    make_pair<string, vector<string>>("s1", {"6", "7", "11", "8", "9", "10"})});

    auto *table2 = new ResultTable({make_pair<string, vector<string>>("s", {"2", "4", "4"}),
                                    make_pair<string, vector<string>>("v", {"x", "x", "y"})});

    auto *expectedTable = new ResultTable({make_pair<string, vector<string>>("s", {"2", "2", "4", "4"}),
...
TEST_CASE("TestCase2_MatchingSingleColumnNoMatchingRows") {
    ...
    auto *table2 = new ResultTable({make_pair<string, vector<string>>("s", {"6", "7", "8"}),
                                    make_pair<string, vector<string>>("v", {"x", "x", "y"})});

    auto *expectedTable = new ResultTable({make_pair<string, vector<string>>("s", {}),
...
TEST_CASE("TestCase3_MatchingRowsInMatchingColumns") {
    ...
    auto *table2 = new ResultTable({make_pair<string, vector<string>>("s", {"2", "4", "4", "4"}),
                                    make_pair<string, vector<string>>("s1", {"7", "4", "9", "9"}),
                                    make_pair<string, vector<string>>("v", {"x", "x", "y", "z"})});

    auto *expectedTable = new ResultTable({make_pair<string, vector<string>>("s", {"2", "4", "4"}),
...
TEST_CASE("TestCase5_NoMatchingColumnsAllUniqueCells") {
    auto *table1 = new ResultTable({make_pair<string, vector<string>>("s1", {"1", "2"}),
...
TEST_CASE("TestCase8_NoMatchingColumnsOneTableEmpty") {
    ...
    auto *table2 = new ResultTable({make_pair<string, vector<string>>("s1", {"1", "2"}),
                                    make_pair<string, vector<string>>("s2", {"6", "7"})});
...
TEST_CASE("TestCase9_NoMatchingColumnsBothTablesEmpty_ReturnFirstTable") {
    ...
    auto *table2 = new ResultTable({make_pair<string, vector<string>>("s1", {}),
                                    make_pair<string, vector<string>>("s2", {})});
...
TEST_CASE("TestCase10_MatchingColumnsBothTablesEmpty") {
    auto *table1 = new ResultTable({make_pair<string, vector<string>>("s1", {}),
                                    make_pair<string, vector<string>>("s2", {})});
...
TEST_CASE("TestCase10_GetSingleColumnExists_Success") {
    auto *table = new ResultTable({make_pair<string, vector<string>>("s1", {}),
                                   make_pair<string, vector<string>>("s2", {})});
...
TEST_CASE("TestCase10_GetSingleColumnWhichDoesNotExist_EmptyTable") {
    auto *table = new ResultTable({make_pair<string, vector<string>>("a", {}),
