...
TEST_CASE("Test 1: Creating BlockToStatementNumbers With Default Constructor") {
    ...
    map<int, vector<int>> result = blockToStatementNumbers->getBlockToStatementNumbersDatabase();
...
TEST_CASE("Test 2: Creating BlockToStatementNumbers With Parameterised Constructor") {
    ...
    map<int, vector<int>> database = blockToStatementNumbers->getBlockToStatementNumbersDatabase();
...
TEST_CASE("Test 4: Copying A New Block To Statement Numbers Database") {
    ...
    map<int, vector<int>> oldDatabase = blockToStatementNumbers->getBlockToStatementNumbersDatabase();
    ...
    map<int, vector<int>> newDatabase = blockToStatementNumbers->getBlockToStatementNumbersDatabase();
