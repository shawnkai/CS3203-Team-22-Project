...
TEST_CASE("Test 1: Creation of InverseCalls Design Abstraction") {
    ...
    SECTION("Using API With A Tuple of Size 2") {
        PKB pkbTest = PKB();
        pkbTest.addDesignAbstraction("INVERSECALLS", make_tuple("a1", "a2"));
...
TEST_CASE("Test 2: Retrieval of InverseCalls Design Abstraction") {
    ...
    SECTION("Using API Without Tuple") {
        ...
        Result result = pkbTest.getDesignAbstraction("INVERSECALLS", "a3");
...
TEST_CASE("Test 8: Retrieval of Variables Captured By InverseCalls Design Abstractions") {
    SECTION("") {
        ...
        unordered_map<string, unordered_set<string>> result =
                pkbTest.getAllVariablesCapturedByDesignAbstraction("INVERSECALLS", "_");
