...
TEST_CASE("Test 1: Test clearAllDatabases() API With Correct Key") {
    ...
    SECTION("Testing Control Flow Graph Database") {
        ...
        REQUIRE(topologicallySortedElementsAfterClearing.empty());
        REQUIRE(blockToStatementNumberElementsAfterClearing.empty());
        REQUIRE(statementNumberToBlockElementsAfterClearing.empty());
        REQUIRE(blockToBlockElementsAfterClearing.empty());
        REQUIRE(blocksWithBackPointersElementsAfterClearing.empty());
    }
}

TEST_CASE("Test 2: Test clearAllDatabases() API With Incorrect Key") {
    SECTION("Testing Design Entities Database") {
        string accessKey = "InvalidKey";
